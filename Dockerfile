...
COPY --from=openjdk:11.0.10-jre-slim-buster "$JAVA_HOME" "$JAVA_HOME"
COPY --from=openjdk:11.0.10-jre-slim-buster /etc/ca-certificates/update.d/docker-openjdk /etc/ca-certificates/update.d/docker-openjdk
