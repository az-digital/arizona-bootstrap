...
<div class="input-group mb-3">
  <div class="input-group-prepend">
    <button class="btn btn-outline-blue dropdown-toggle" type="button" data-toggle="dropdown" aria-expanded="false">Dropdown</button>
...
<div class="input-group mb-3">
  <div class="input-group-prepend">
    ...
    <button type="button" class="btn btn-outline-blue dropdown-toggle dropdown-toggle-split" data-toggle="dropdown" aria-expanded="false">
