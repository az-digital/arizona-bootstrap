...
<div class="card" style="width: 18rem;">
  <div class="card-body">
    <h5 class="card-title">Card title</h5>
    <h6 class="card-subtitle mb-2 text-body-blue">Card subtitle</h6>
    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
...
<div class="card text-center">
  ...
  <div class="card-footer text-body-blue">
    2 days ago
  </div>
</div>
{{< /example >}}
...
<div class="card mb-3">
  ...
  <div class="card-body">
    ...
    <p class="card-text"><small class="text-body-blue">Last updated 3 mins ago</small></p>
  </div>
</div>
<div class="card">
  <div class="card-body">
...
<div class="card-group">
  <div class="card">
    ...
    <div class="card-footer">
      <small class="text-body-blue">Last updated 3 mins ago</small>
    </div>
  </div>
  <div class="card">
    {{< placeholder width="100%" height="180" class="card-img-top" text="Image cap" >}}
