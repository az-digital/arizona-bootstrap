...
<nav class="navbar bg-body-tertiary">
  <div class="container">
    <a class="navbar-brand" href="#">
      <img src="{{<docsextraref "/assets/brand/arizona-bootstrap-logo-black-background.svg" >}}" alt="Bootstrap" width="37" height="37">
    </a>
  </div>
</nav>
{{< /example >}}
...
<nav class="navbar bg-body-tertiary">
  <div class="container-fluid">
    <a class="navbar-brand" href="#">
      <img src="{{<docsextraref "/assets/brand/arizona-bootstrap-logo-black-background.svg" >}}" alt="Logo" width="37" height="37" class="d-inline-block align-text-center">
      Arizona Bootstrap
    </a>
  </div>
</nav>
