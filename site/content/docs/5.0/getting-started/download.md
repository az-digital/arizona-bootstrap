...
<a href="{{< param "download.dist" >}}" class="btn btn-red">Download</a>
...
<a href="{{< param "download.source" >}}" class="btn btn-red">Download source</a>

## Examples

If you want to download and examine our [examples]({{< docsref "/examples" >}}), you can grab the already built examples:

<a href="{{< param "download.dist_examples" >}}" class="btn btn-red">Download Examples</a>
