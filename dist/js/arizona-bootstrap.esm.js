/*!
  * Arizona Bootstrap v5.1.2 (https://github.com/az-digital/arizona-bootstrap)
...
class NavbarAzFullscreenMobileNav {
   ...
   */
  showNavMenu(content, label, navType, backButtonLabel) {
    var parentLabel = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : null;
  ...
  buildMenuHtml(content, label, backButtonLabel) {
    ...
    if (nav) {
      ...
      for (var button of buttons) {
        ...
        // Create dynamic id
        buttonCounter++;
        button.id = "az-fullscreen-nav-mobile-".concat(buttonCounter);
...
export { Alert, AzTab, Button, Carousel, Collapse, Dropdown, Modal, NavbarAzFullscreenMobileNav, Offcanvas, Popover, ScrollSpy, Tab, Toast, Tooltip, enableAzNavbar$1 as enableAzNavbar, fixModalAriaHidden$1 as fixModalAriaHidden, photoGalleryGridSlideToImage$1 as photoGalleryGridSlideToImage };
