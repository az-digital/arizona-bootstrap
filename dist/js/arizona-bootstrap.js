...
(function (global, factory) {
  ...
  var name = "arizona-bootstrap";
  var version = "0.0.4-dev";
  var version_short = "0.0";
  var description = "University of Arizona theme for Bootstrap.";
  var scripts = {
  	...
  	"css-compile-main": "node-sass --output-style expanded --source-map true --source-map-contents true --precision 6 scss/arizona-bootstrap.scss dist/css/arizona-bootstrap.css && npm run css-copy",
  	...
  	"css-lint-vars": "fusv scss/ site/docs/ --ignore '$enable-rounded,$font-family-monospace,$font-family-base,$enable-responsive-font-sizing'",
  	"css-minify": "npm-run-all --parallel css-minify-*",
  	"css-minify-main": "cleancss --level 1 --format breakWith=lf --source-map --source-map-inline-sources --output dist/css/arizona-bootstrap.min.css dist/css/arizona-bootstrap.css",
  	...
  	"docs-linkinator": "linkinator _site/ --recurse --silent --skip \"^(?!http://localhost)\"",
  	...
  	"js-lint-main": "eslint --report-unused-disable-directives --cache --cache-location .cache/.eslintcache js/src build/",
  	...
  	"js-minify-standalone": "terser --compress typeofs=false --mangle --comments \"/^!/\" --source-map \"content=dist/js/arizona-bootstrap.js.map,includeSources,url=arizona-bootstrap.min.js.map\" --output dist/js/arizona-bootstrap.min.js dist/js/arizona-bootstrap.js",
  	"js-minify-bundle": "terser --compress typeofs=false --mangle --comments \"/^!/\" --source-map \"content=dist/js/arizona-bootstrap.bundle.js.map,includeSources,url=arizona-bootstrap.bundle.min.js.map\" --output dist/js/arizona-bootstrap.bundle.min.js dist/js/arizona-bootstrap.bundle.js",
  ...
  var style = "dist/css/arizona-bootstrap.css";
  var sass = "scss/arizona-bootstrap.scss";
  var main = "dist/js/arizona-bootstrap.js";
  var repository = {
  	type: "git",
  	url: "git+https://github.com/az-digital/arizona-bootstrap.git"
  };
  var author = "Arizona Digital Contributors";
  var bugs = {
  	url: "https://github.com/az-digital/arizona-bootstrap/issues"
  };
  var license = "MIT";
  var homepage = "https://github.com/az-digital/arizona-bootstrap";
  var dependencies = {
  };
